...
class kmeans:
    ...
    def predict(self, X):
        ...
        for _ in range(self.max_iters):
            # need to first update clusters then centroids
            ...
            if self._is_converged(centroids_old, self.centroids): break
            if self.plot_steps: self.plot()
    ...
    def _is_converged(self, centroids_old, centroids): 
        ...
        # if the distance is 0, no more distances
